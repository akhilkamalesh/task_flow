# Enhancements 
### Markdown will contain enhancements and defects for features. Will be treated as a working document for tracking purposes. Will be broken out by feature name.

## Authentication

## Board
1. DONE - For the Done, only show the tasks that were done within the week. The rest should be archived.
2. DONE - For the Done board, should be sorted date descending
